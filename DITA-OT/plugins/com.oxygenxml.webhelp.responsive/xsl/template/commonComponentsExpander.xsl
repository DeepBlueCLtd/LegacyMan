...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="html:topicsubject" mode="generate-facets">
      <xsl:variable name="facetValue" select="html:subjectref/@keyref"/>
      <xsl:variable name="facetParent" select="current()/@keyref"/>
      <xsl:if test="exists($facetParent) and exists($facetValue) and 
