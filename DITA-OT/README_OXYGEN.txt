DITA Open Toolkit bundled with Oxygen 26.0, build 2023100622
...
org.dita.pdf2.fop
	...
	Updated used Batik library to version 1.17, XML Graphics Commons and FOP libraries to 2.9.
...
OPE-204 Keep logback-*-1.2.x and slf4j-api-1.7.x for compatibility reason
lib/xmlresolver-5.2.1.jar
OPE-54 Updated the JAR library to version 5.2.1 for a better security policy handling
